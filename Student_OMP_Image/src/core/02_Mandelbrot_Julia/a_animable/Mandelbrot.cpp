...
Mandelbrot::Mandelbrot(uint w, uint h, uint nMin, uint nMax, const DomaineMath& domaineMath) :
	Animable_I<uchar4>(w, h, "MandelBrot_OMP_rgba_uchar4",domaineMath), variateurAnimation(Interval<uint>(nMin, nMax), 1)
    {
    // Input
    this->n = n;
